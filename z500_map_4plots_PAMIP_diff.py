...
if __name__ == '__main__':
    ...
    for season in ['_DJF', '_MAM', '_JJA', '_SON']:
       ...
       data1 = dataset1.variables[param][:]/gravityfactor
       data2 = dataset2.variables[param][:]/gravityfactor
    ...
    fig.colorbar(cs, cax=cbar_ax, orientation='vertical', extend='both',ticks=[-36,-28,-20,-12,-4,4,12,20,28,36])
    fig.savefig(datapath2+paramname+'_'+exp2+'_'+exp1+'_'+res+'_map_diff.png')

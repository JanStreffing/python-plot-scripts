...
datapath1='/mnt/lustre01/work/ba1035/a270092/runtime/oifsamip/'+res+'/Experiment_'+obsname+'/synact/'
datapath2='/mnt/lustre01/work/ba1035/a270092/runtime/oifsamip/'+res+'/Experiment_'+modelname+'/synact/'


for season in ['_DJF', '_MAM', '_JJA', '_SON']:

   print season
   ncfile=datapath1+paramobs+'_timstd'+season+'.nc'
   print ncfile
   ...
   ncfile=datapath2+parammodel+'_timstd'+season+'.nc'
   print ncfile
   f = netcdf.netcdf_file(ncfile, 'r')

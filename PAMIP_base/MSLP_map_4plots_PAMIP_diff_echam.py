...
if __name__ == '__main__':
    ...
    exp2='13'
    res='T63'
    datapath1='/work/bk0988/awicm/a270062/cpl_output_'+res+'_PAMIP'+exp1+'_PI_ATMO/'
    datapath2='/work/bk0988/awicm/a270062/cpl_output_'+res+'_PAMIP'+exp2+'_PI_ATMO/'
    ...
    for season in ['_DJF', '_MAM', '_JJA', '_SON']:
       ...
       ncfile1 = datapath1+paramname+'___avg'+season+'.nc'
       ncfile2 = datapath2+paramname+'___avg'+season+'.nc'
       print ncfile1
       print ncfile2
    ...
    fig.savefig(datapath_out+'MSL'+'_'+exp2+'-'+exp1+'_'+res+'_map_diff.png')

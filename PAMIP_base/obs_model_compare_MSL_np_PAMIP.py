...
parammodel='Z_V_MSLP'
paramname='MSLP'
parammodelintern='var151'
paramobs='msl'
paramobsintern='var151'
paramlongname='Mean sea level pressure [hPa]'
timerangemodel=''
timerangeobs='1957_2002'
modelname='ECHAM_T63_p1'
obsname='ERA40'
modelfac=0.01
obsfac=0.01
levels=[985, 990, 995, 1000, 1005, 1010, 1015, 1020, 1025]
levelsdiff=[-12, -9, -6, -3, -1, 1, 3, 6, 9, 12]

datapath='/work/bk0988/awicm/a270062/cpl_output_T63_PAMIPp1_PI_ATMO/'
...
for season in ['_DJF', '_MAM', '_JJA', '_SON', '']:
   ...
   ncfile=datapath+parammodel+'_'+timerangemodel+'__avg'+season+'.nc'
   print ncfile
   f = netcdf.netcdf_file(ncfile, 'r')

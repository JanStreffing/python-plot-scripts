...
for season in ['DJF','MAM','JJA','SON']:
	...
	ncfile1 = basepath+resolution+'/Experiment_'+exp1+'/ensemble_mean/'+paramname+'_ensmean_'+season+'.nc'
	ncfile2 = basepath+resolution+'/Experiment_'+exp2+'/ensemble_mean/'+paramname+'_ensmean_'+season+'.nc'
	...
	plot.append(Ngl.contour(wks,var2-var1,res))	#-- create contour plot

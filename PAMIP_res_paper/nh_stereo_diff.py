...
if str(sys.argv[9]) == "colorbar_TR_15":
	print("loading colorbar_TR_15")
	from colorbar_TR_15 import cmap_TR
if str(sys.argv[9]) == "colorbar_TR_70":
	print("loading colorbar_TR_70")
...
if __name__ == '__main__':
    ...
    for season in ['_DJF', '_MAM', '_JJA', '_SON']:
       ...
       im=plt.contourf(lons, lats, data_cat2-data_cat1, levels=mapticks, cmap=cmap_TR, extend='both',transform=ccrs.PlateCarree())

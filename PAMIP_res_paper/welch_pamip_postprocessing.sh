...
for todo in T2M #NAO SD T2M z500 MSL MSL U V synact
do
	...
	do
		...
		# t2m hPa polar plots 
		if [[ "$todo" == "T2M" ]]; then
			python nh_stereo_diff_welch.py 11 16 $season T2M T2M $in_mistral 1 $out_mistral true -7,-5,-3,-1,-0.5,-0.3,-0.1,0.1,0.3,0.5,1,3,5,7 colorbar_TR_70 18 T159,T511
		fi
